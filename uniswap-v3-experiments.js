...
const experimentalABI = require('./experimentalABI.json');
...
const fromContract = new web3.eth.Contract(erc20ABI, fromToken);
const toContract = new web3.eth.Contract(erc20ABI, toToken);


// Created WETH/DAI Pool 0xa187d6bdee6edfc7fbfc6819464c0f31d34952d1
const createLiquidityPool = async () => {
	let txRaw = factoryContract.methods.createPool(fromToken,toToken,500);
...
const addLiquidity = async () => {
	...
	//let txRaw = positionManagerContract.methods.createAndInitializePoolIfNecessary(fromToken,toToken,500,200)	
